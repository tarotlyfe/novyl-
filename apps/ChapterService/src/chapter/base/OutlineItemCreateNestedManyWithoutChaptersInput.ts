...
@InputType()
class OutlineItemCreateNestedManyWithoutChaptersInput {
...
export { OutlineItemCreateNestedManyWithoutChaptersInput as OutlineItemCreateNestedManyWithoutChaptersInput };
